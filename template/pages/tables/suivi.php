  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" href="../forms/profil.php">
            <span class="menu-icon">
          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Suivi d'Etat</li>
              </ol>
            </nav>
          </div>
                      ...
                      <tbody>
                        ...
                        <a href="suivip.php">
                          <tr>
                            ...
                            <td><label class="badge badge-info">Télécharger</label><label class="badge badge-info">Détails</label></td>
                          </tr>
                          </a>
                        <?php } }elseif (isset($_GET['etat']) == 'en cours'){
                        ...
                        <?php } }elseif (isset($_GET['etat']) == 'Accepté'){
                        ...
                        <?php } }elseif (isset($_GET['etat']) == 'Rejeté'){
