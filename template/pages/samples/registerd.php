...
<body>
  ...
  if (!empty($_POST)) {
    ...
    $req = $pdo->prepare("INSERT INTO dossiers SET username = ?, project_name = ?,type = ?, etat= ?, add_at = NOW(), file_path = ?");

    $etat_dossier = 'en attente';
    $req->execute([$_SESSION['auth']->username, $_POST['project_name'],$_POST['type'], $etat_dossier, $target_file]);
  }
          ...
          <div class="profile-desc">
            ...
            <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown">
              ...
              <a href="#" class="dropdown-item preview-item">
                ...
                <div class="preview-item-content">
                  <p class="preview-subject ellipsis mb-1 text-small">Changement du mot de passe</p>
                </div>
              </a>
              <div class="dropdown-divider"></div>
              <a href="#" class="dropdown-item preview-item">
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="auth">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="registerd.php"> Depot </a></li>
              <li class="nav-item"> <a class="nav-link" href="etatd.php"> Etat </a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item menu-items">
            ...
            <li class="nav-item dropdown border-left">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                ...
                <a class="dropdown-item preview-item">
                  ...
                  <div class="preview-item-content">
                    <p class="preview-subject mb-1">Finalisation d'Inscription!</p>
                    <p class="text-muted ellipsis mb-0"> Vos données ont étés ajoutées avec succès! </p>
                  </div>
                </a>
                <div class="dropdown-divider"></div>
                <p class="p-3 mb-0 text-center">1 new notification</p>
              </div>
            </li>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title"> Déposez un nouveau dossier! </h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../../index.php">Acceuil</a></li>
                <li class="breadcrumb-item active" aria-current="registerd.php">Dossier</li>
                <li class="breadcrumb-item active" aria-current="registerd.php">Depot</li>
              </ol>
            </nav>
          </div>
            ...
            <div class=" stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Dépôt</h4>
                  <form class="form-sample" action="" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                      <label>Choisissez un nom pour votre dossier</label>
                      
                  <input type="text" name="project_name" class="form-control p_input" required>
                     
                    </div>
                    <div class="form-group">
                      <label>Choisissez le type du dossier</label>
                      <select name="type" class="js-example-basic-single" style="width:100%">
                        <option value="dossier_s">Dossier Scientifique</option>
                        <option value="dossier_p">Dossier Pédagogique</option>
                        <option value="dossier_a">Dossier Administratif</option>
                      </select>
                    </div>
                    ...
                    <div class="custom-file">
                      ...
                      <label class="custom-file-label" for="chooseFile">Répertoire</label>
                    </div>
